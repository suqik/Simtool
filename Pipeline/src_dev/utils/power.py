...
def get_powerspec_bigfile(bigfilecat, Nmesh, MAS="CIC", kmin=None, kmax=None, nk=None, multipoles=[0], threads=None):
    delta = bigfilecat.to_mesh(Nmesh=Nmesh).preview()
    boxsize = bigfilecat.attrs['BoxSize'][0]
    Pk = PKL.Pk(delta, boxsize, axis=0, MAS=MAS, threads=threads)
